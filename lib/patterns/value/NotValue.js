...
var _ValuePattern2 = _interopRequireDefault(require("./ValuePattern"));
...
function (_ValuePattern) {
  ...
  function NotValue(name, pattern) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NotValue).call(this));
    _this.name = name;
  ...
  _createClass(NotValue, [{
    ...
    value: function processMatch() {
      if (this.match.length === 0) {
        throw new _ParseError.default("Didn't find any characters the didn't match the ".concat(this.pattern.getName(), " pattern."), this.mark.index, this);
      } else {
