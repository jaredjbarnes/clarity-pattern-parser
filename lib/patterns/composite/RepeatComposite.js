...
function (_CompositePattern) {
  ...
  function RepeatComposite() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(RepeatComposite).apply(this, arguments));
  }
  ...
  _createClass(RepeatComposite, [{
    ...
    value: function _processValue() {
      if (this.nodes.length === 0) {
        throw new ParseError("Couldn't find the ".concat(this.pattern.name, " pattern."), this.mark.index, this);
      }
