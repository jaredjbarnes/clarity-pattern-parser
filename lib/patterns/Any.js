...
class Any {
  ...
  reduceValue() {
    ...
    if (this.options.isValue) {
      ...
      this.value = new _ValueNode.default(this.name, this.value, this.filteredNodes[0].startIndex, this.filteredNodes[this.filteredNodes.length - 1].endIndex);
    } else {
      this.value = new _CompositeNode.default(this.name, this.filteredNodes[0].startIndex, this.filteredNodes[this.filteredNodes.length - 1].endIndex);
