...
function (_Node) {
  ...
  function CompositeNode(type) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CompositeNode).call(this, type, startIndex, endIndex));
    _this.children = [];
    return _this;
  }
  ...
  _createClass(CompositeNode, [{
    ...
    value: function clone() {
      var node = new CompositeNode(this.type, this.startIndex, this.endIndex);
