...
exports["OptionalValue: getName, getType"] = function () {
  var john = new _Literal.default("john", "John");
  var optionalValue = new _OptionalValue.default(john);

  _assert.default.equal(optionalValue.getName(), john.getName());

  _assert.default.equal(optionalValue.getType(), john.getType());
};
