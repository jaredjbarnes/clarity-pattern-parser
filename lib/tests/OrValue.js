...
exports["OrValue: Name and patterns."] = function () {
  ...
  _assert.default.equal(letterNode.name, "alpha-numeric");

  _assert.default.equal(letterNode.value, "a");

  _assert.default.equal(numberNode.name, "alpha-numeric");
...
exports["OrValue: Fail."] = function () {
  ...
  _assert.default.equal(letterCursor.getIndex(), 0);

  _assert.default.equal(letterCursor.hasUnresolvedError(), true);

  _assert.default.equal(numberCursor.getIndex(), 0);

  _assert.default.equal(numberCursor.hasUnresolvedError(), true);
};
...
exports["OrValue: Clone."] = function () {
  ...
  _assert.default.equal(alphaNumeric.children.length, clone.children.length);

  _assert.default.equal(alphaNumeric.name, clone.name);
};
...
exports["OrValue: Last pattern matches."] = function () {
  ...
  _assert.default.equal(node.name, "test");
