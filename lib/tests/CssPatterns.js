...
exports["Css: All known unit values spaced"] = function () {
  ...
  _assert.default.equal(cursor.string, result.toString());
};
...
exports["Css: getPossibilities"] = function () {
  var result = _cssValue.default.getPossibilities();

  var cssString = "rgba(0,0,0,0), &8sd";

  var parseResult = _cssValue.default.parse(new _index.Cursor(cssString));
};
