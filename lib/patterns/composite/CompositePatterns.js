...
var CompositePatterns =
/*#__PURE__*/
function (_Pattern) {
  _inherits(CompositePatterns, _Pattern);

  function CompositePatterns(name, patterns) {
    var _this;

    _classCallCheck(this, CompositePatterns);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CompositePatterns).call(this));
    _this.name = name;
  ...
  _createClass(CompositePatterns, [{
    key: "assertArguments",
