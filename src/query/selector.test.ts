...
describe("Selector", () => {
  ...
  test("Direct Child", () => {
    ...
    expect(result.map(n => n.toString()).join(",")).toEqual(
      "1234,5678,9101112,13141516,17181920,21222324"
    );
  });
  ...
  test("Not Equal Attribute", () => {
    ...
    expect(result.map(n => n.toString()).join(",")).toEqual(
      "1,2,3,1234,5,6,7,8,5678,9,10,11,12,9101112,123456789101112,13,14,15,16,13141516,17,18,19,20,17181920,21,22,23,24,21222324,131415161718192021222324,123456789101112131415161718192021222324"
    );
  });
  ...
  test("Starts With Attribute", () => {
    ...
    expect(result.map(n => n.toString()).join(",")).toEqual(
      "1,1234,10,11,12,123456789101112,13,14,15,16,13141516,17,18,19,17181920,131415161718192021222324,123456789101112131415161718192021222324"
    );
  });
  ...
  test("Ends With Attribute", () => {
    ...
    expect(result.map(n => n.toString()).join(",")).toEqual(
      "2,12,9101112,123456789101112,22"
    );
  });
  ...
  test("Contains Attribute", () => {
    ...
    expect(result.map(n => n.toString()).join(",")).toEqual(
      "2,1234,12,9101112,123456789101112,20,17181920,21,22,23,24,21222324,131415161718192021222324,123456789101112131415161718192021222324"
    );
  });
  ...
  test("Greater Than Or Equal Attribute", () => {
    ...
    expect(result.length).toBe(6);
    expect(result.map(n => n.toString()).join(",")).toEqual(
      "22,23,24,21222324,131415161718192021222324,123456789101112131415161718192021222324"
    );
  });
  ...
  test("Greater Than Attribute", () => {
    ...
    expect(result.length).toBe(5);
    expect(result.map(n => n.toString()).join(",")).toEqual(
      "23,24,21222324,131415161718192021222324,123456789101112131415161718192021222324"
    );
  });
