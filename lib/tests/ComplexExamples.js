...
exports["Complex Examples: Natural Language."] = () => {
  const validCursor = new _Cursor.default("Match records where firstName is 'John' and lastName is 'Barnes'.");
  const invalidCursor = new _Cursor.default("Match records where firstName ");
